...
const AddMotorcycle = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.name) newErrors.name = 'Motorcycle name is required';
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">List Your Motorcycle</h1>
          <p className="text-gray-600">Share your motorcycle and start earning money today</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="125"
                  min="50"
                  className={`w-full px-4 py-2.5 border ${errors.engineSize ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900`}
                />
                {errors.engineSize && (
                  <div className="flex items-center mt-2 text-red-600 text-sm">
                    <AlertCircle className="w-4 h-4 mr-1" />
          ...
          {/* Features */}
          <div className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-6">Features & Included Items</h2>
