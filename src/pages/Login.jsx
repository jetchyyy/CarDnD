      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            {isLogin ? 'Sign in to continue to CarDnD' : 'Join CarDnD and start your journey'}
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="space-y-6">
            ...
            {!isLogin && (
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border ${errors.fullName ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors text-gray-900`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full pl-10 pr-4 py-3 border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors text-gray-900`}
                    placeholder="••••••••"
                  />
                </div>
            ...
            <button
              ...
              className="w-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-3 rounded-lg transition duration-200 flex items-center justify-center"
            >
